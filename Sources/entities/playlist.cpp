...
Playlist::Playlist() : id(0), listenerId(0), isFavorite(false) {}
...
const std::vector<int>& Playlist::getSongIds() const { return songIds; }
bool Playlist::getIsFavorite() const { return isFavorite; }

void Playlist::setName(const std::string& newName) { name = newName; }
void Playlist::setIsFavorite(bool favorite) { isFavorite = favorite; }
